function config()
    ...
    local ops = {
        ...
        -- WARN: specifying this file drives plugin absolutely WILD
        firefox_profiles_ini_path = '/home/dzu/.mozilla/firefox/profiles.ini',
...
return {
    ...
    build = "pip3 install --break-system-packages --user .",
    -- build = "conda run --no-capture-output -n jupynium pip install .",
    -- enabled = vim.env.VIRTUAL_ENV,
    dependencies = {
